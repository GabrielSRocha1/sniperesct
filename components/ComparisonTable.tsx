...
const TABLE_DATA = [
  { symbol: 'BDC', name: 'BodeCoin', color: '#10b981', aporte: 1000, qtd: 76394.3245, roi: '12,000%', icon: '🐐' },
  { symbol: 'SOL', name: 'Solana', color: '#14F195', aporte: 1000, qtd: 7.8423, roi: '220%', icon: '◎' },
  { symbol: 'ETH', name: 'Ethereum', color: '#F97316', aporte: 1000, qtd: 0.3428, roi: '80%', icon: 'Ξ' },
  { symbol: 'BTC', name: 'Bitcoin', color: '#FFC107', aporte: 1000, qtd: 0.0112, roi: '110%', icon: '₿' },
];
